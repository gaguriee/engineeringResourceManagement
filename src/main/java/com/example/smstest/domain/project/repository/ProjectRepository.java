...
//
    @Query("SELECT p FROM Project p WHERE p.name LIKE %:keyword% OR p.client.name LIKE %:keyword% ")
    Page<Project> findByNameContaining(@Param("keyword") String keyword, Pageable pageable);
//
